...
export const WorkHistory: WorkHistoryItem[] = [
  {
    ...
    from: '2021-02-01',
    description: 'Leading full-stack development across multiple teams to deliver high-quality software solutions',
    keyNotes: [
  ...
  },
  {
    ...
    from: '2020-11-02',
    to: '2021-01-22',
    description: 'Development of integration APIs for 3rd-party finance systems',
    keyNotes: [
  ...
  },
  {
    ...
    tags: ['ASP.NET Core', 'React', 'AWS', 'SQS/SNS', 'Lambda', 'Git', 'TeamCity', 'OctoDeploy'],
  },
  {
    title: 'Lead Developer',
    ...
    tags: ['ASP.NET Core', 'AngularJS', 'Angular', 'Azure', 'SVN', 'TeamCity', 'OctoDeploy'],
  },
  {
    ...
    tags: ['ASP.NET', 'AngularJS', 'SignalR', 'SQL Server', 'Redis', 'MongoDB', 'TeamCity'],
  },
  {
    title: 'Senior Developer',
    ...
    tags: ['ASP.NET', 'AngularJS', 'KnockoutJS', 'SQL Server', 'SQL Azure', 'WPF'],
  },
  {
    ...
    tags: ['WPF', 'Silverlight', 'WinForms', 'SQL Server', 'PostGIS', 'ASP.NET'],
  },
]
...
export const Skills: SkillsItem[] = [
  ...
  {
    name: 'Frontend',
    skills: ['JavaScript', 'TypeScript', 'CSS/SASS/LESS/Tailwind', 'AngularJS', 'Angular 2+ (to 13)', 'React'],
  },
  {
    name: 'DevOps',
    skills: ['Azure DevOps', 'CI/CD', 'Static Code Analysis', 'TeamCity', 'Octopus', 'Git', 'YAML Pipelines'],
  },
  {
    name: 'Knowledgeable',
    skills: ['Docker', 'BDD', 'TDD', 'Unit Testing', 'Node.js', 'Agile', 'SCRUM', 'Mongo', 'Dynamo', 'Dapper'],
  },
]
