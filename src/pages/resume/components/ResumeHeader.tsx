      ...
      <div className="text-gray-800 lg:text-white lg:bg-resume print:bg-white print:text-black">
        <div className="flex flex-col items-center lg:items-start print:items-start lg:flex-row print:flex-row">
          ...
          <div className="relative w-full lg:w-auto print:hidden">
            ...
            <img src="dp_profile.png" className="w-1/2 border-8 border-white lg:border-0 z-10 my-6 mx-auto rounded-full lg:rounded-none lg:m-0 lg:w-auto lg:h-auto relative" alt="Profile" />
          ...
          <div className="text-center lg:text-left print:text-left flex-1 p-2 lg:p-6 print:p-0">
            ...
            {/* Name & Title */}
            <div className="lg:uppercase whitespace-no-wrap truncate text-4xl lg:text-4xl lg:tracking-widest font-black print:text-3xl">{PersonalDetails.name}</div>
            <div className="text-2xl whitespace-no-wrap truncate mb-4 lg:mb-1">{PersonalDetails.title}</div>
