...
export const workHistory = [{
    title: "Application Architect & Lead Developer",
    employer: "NHS Property Services",
    from: "2021-02-01",
    description: "Providing architectural support for application development",
    keyNotes: [
        "Design and development of Customer Portal application for consolidating internal systems",
    ...
    tags: [
        "ASP.NET Core", "Angular 11", "Azure", "Azure DevOps", "YAML", "ARM Templates", "MSSQL"
    ]
},{
    ...
    from: "2020-11-02",
    to: "2021-01-22",
    description: "Development of integration APIs for 3rd-party finance applications",
    keyNotes: [
    ...
    tags: [
        "ASP.NET Core", "Azure", "Azure DevOps"
    ]
},
{
