...
export default () => {
    ...
    let links = Data.links.map((link, i) =>
        <li className="mb-1 md:mb-3 print:mb-1" key={i}>
            <a href={link.url} className="flex flex-row flex-end md:flex-row-reverse text-gray-600 md:text-gray-500 text-sm md:text-base whitespace-no-wrap truncate" target="_blank" rel="noopener noreferrer">
        ...
        <header className="">
            <div className="text-gray-800 md:text-white md:bg-resume print:bg-white print:text-black">
                <div className="flex flex-col items-center md:items-start print:items-start md:flex-row print:flex-row">
                    ...
                    {/* Link */}
                    <div className="p-2 md:p-4 lg:p-4 print:p-0 w-full md:w-auto">
